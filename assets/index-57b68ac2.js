				...
				<section>
					...
					<article class="bracket" style="min-height: 6rem;">
						...
						<ul class="triangle-right-bullet">
							...
							<li class="software cpp">C++ (C++11, C++14, C++17, C++20, C++23) <app-stars stars="5"></app-stars></li>
					...
					<article class="bracket" style="min-height: 17rem;">
						...
						<ul class="triangle-right-bullet">
							...
							<li class="software cpp">CppTest <app-stars stars="3"></app-stars></li>
							<li class="software cpp">GoogleTest <app-stars stars="3"></app-stars></li>
					...
					<article class="bracket" style="min-height: 13rem;">
						...
						<ul class="triangle-right-bullet">
							<li>OS: Windows & Linux (Arch, Debian, Mint, OpenSUSE, Ubuntu)</li>
							<li>IDE: <span class="software cpp">Visual Studio, QtCreator, Eclipse, </span>VSCode</li>
							<li>CI/CD: Github Actions, Travis CI, Jenkins, Microsoft Azure DevOps</li>
							...
							<li>Autres: Ansible, <span class="web">NodeJS, PhpMyAdmin, Matomo (Piwik), WampServer, Laragon, PM2, Babel, Wordpress, Prestashop, </span>Suite Office, Google Analytics, Azure Dataflow, Azure Databricks, Blender, Cinema4D</li>
						</ul>
					</article>
					<article class="bracket" style="min-height: 6rem;">
						<h4>Langues</h4>
